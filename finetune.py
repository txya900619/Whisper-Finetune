...
add_arg(
    "base_model", type=str, default="openai/whisper-large-v3", help="Whisper的基础模型"
)
add_arg("output_dir", type=str, default="output/", help="训练保存模型的路径")
add_arg("warmup_steps", type=int, default=4255, help="训练预热步数") # 50
...
add_arg("learning_rate", type=float, default=7e-5, help="学习率大小")
...
os.environ["WANDB_PROJECT"] = "whisper-hakka"

dataset_metadata_list = [
    {"path": "/mnt/FormoData/fsr23_hakka/dataset/train.json", "prompt": "htia_sixian"},
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/sixian_vocabulary.json",
        "prompt": "htia_sixian",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/sixian_example.json",
        "prompt": "htia_sixian",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/hailu_vocabulary.json",
        "prompt": "htia_hailu",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/hailu_example.json",
        "prompt": "htia_hailu",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/dapu_vocabulary.json",
        "prompt": "htia_dapu",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/dapu_example.json",
        "prompt": "htia_dapu",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/raoping_vocabulary.json",
        "prompt": "htia_raoping",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/raoping_example.json",
        "prompt": "htia_raoping",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/zhaoan_vocabulary.json",
        "prompt": "htia_zhaoan",
    },
    {
        "path": "/mnt/FormoData/hac_vocab/dataset/zhaoan_example.json",
        "prompt": "htia_zhaoan",
    },
    {
        "path": "/mnt/FormoData/HAT/hat_asr/dataset/sixian_reading.json",
        "prompt": "htia_sixian",
    },
    {
        "path": "/mnt/FormoData/HAT/hat_asr/dataset/hailu_reading.json",
        "prompt": "htia_hailu",
    },
    {
        "path": "/mnt/FormoData/HAT/hat_asr/dataset/nansixian_reading.json",
        "prompt": "htia_nansixian",
    },
    {
        "path": "/mnt/FormoData/HAT/hat_asr/dataset/sixian_broadcast.json",
        "prompt": "htia_sixian",
    },
    {"path": "/mnt/FormoData/HAT/hat_tts/dataset/sixian.json", "prompt": "htia_sixian"},
    {"path": "/mnt/FormoData/HAT/hat_tts/dataset/hailu.json", "prompt": "htia_hailu"},
    {
        "path": "/mnt/FormoData/moe_hakkadict/dataset/sixian.json",
        "prompt": "htia_sixian",
    },
    {"path": "/mnt/FormoData/moe_hakkadict/dataset/hailu.json", "prompt": "htia_hailu"},
    {
        "path": "/mnt/FormoData/moe_hakkadict/dataset/nansixian.json",
        "prompt": "htia_nansixian",
    },
    {"path": "/mnt/FormoData/moe_hakkadict/dataset/dapu.json", "prompt": "htia_dapu"},
    {
        "path": "/mnt/FormoData/moe_hakkadict/dataset/raoping.json",
        "prompt": "htia_raoping",
    },
    {
        "path": "/mnt/FormoData/moe_hakkadict/dataset/zhaoan.json",
        "prompt": "htia_zhaoan",
    },
]
...
def main():
    ...
    # print(processor.decode(train_dataset[0]["labels"]))

    print(f"训练数据：{len(train_dataset)}，测试数据：{len(test_dataset)}")

    # 数据padding器
    data_collator = DataCollatorSpeechSeq2SeqWithPadding(processor=processor)
    # d = data_collator([train_dataset[0], train_dataset[1]])
    # print(processor.decode(d["labels"][0].tolist()))
    # print(processor.decode(d["decoder_input_ids"][0].tolist()))
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        bf16=args.fp16,  # 是否使用半精度训练
        report_to=["wandb"],  # 指定使用tensorboard保存log
